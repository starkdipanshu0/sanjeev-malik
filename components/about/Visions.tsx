...
const Visions = () => {
    return (
        <section className="relative py-20 md:py-32 bg-zinc-950 text-white overflow-hidden flex items-center justify-center min-h-[60vh]">
            {/* Ambient Background */}
            ...
            <div className="mx-auto w-full max-w-7xl px-6 md:px-12 relative z-10 text-center">
                <motion.div
